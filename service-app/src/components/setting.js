    ...
    <div className="d-flex flex-column align-items-center px-3 container">
      ...
      <Row className="justify-content-center w-100">
        <Col xs={12} sm={6} md={4} lg={3} className="mb-4">
          <Link to="/service/setting/division" className="text-decoration-none">
        ...
        <Col xs={12} sm={6} md={4} lg={3} className="mb-4">
          <Link to="/service/setting/permission" className="text-decoration-none">
            <Card className="shadow-sm p-4 text-center rounded-3 d-flex justify-content-center align-items-center">
        ...
        <Col xs={12} sm={6} md={4} lg={3} className="mb-4">
          <Link to="/service/setting/type" className="text-decoration-none">
            <Card className="shadow-sm p-4 text-center rounded-3 d-flex justify-content-center align-items-center">
