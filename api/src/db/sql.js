...
/**
 * The function `connectDB` establishes a connection to a Microsoft SQL Server database using a
 * connection pool.
 * @returns The `connectDB` function returns a Promise that resolves to the `poolPromise` object, which
 * represents a connection pool to a MSSQL database.
 */
